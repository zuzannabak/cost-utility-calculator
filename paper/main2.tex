...
\noindent\emph{Implementation note (v1):} The current release computes CO$_2$ \emph{post hoc}; the $\kappa$ constraint is not enforced by the solver. We leave the hard cap $E_{\max}$ for future work (§6.3).
...
% (Optional) If you want this unnumbered section to appear in the ToC:
% \addcontentsline{toc}{section}{7 Lessons Learned}
